# Generated by Powerlevel10k configuration wizard on 2022-10-06 at 16:44 AEDT.
...
# disconnected, right frame, dark-ornaments, sparse, many icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%208F'  # orange foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=14
