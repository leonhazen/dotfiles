...
local IP = "192.168.1.139" -- IP address for TV
local mode = "pc" -- Mode for HDMI input
local name = '"Macbook"' -- Name for HDMI input
local bscpylgtv = "bscpylgtvcommand" -- -- Full path to "bscpylgtvcommand" executable
...
local lgtv_path = "lgtv" -- Full path to lgtv executable
